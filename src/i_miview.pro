;+
; Name: i_miview
; Purpose: show mono interstitial information from defect track
; Input: i_miview, ptd
; History:
;   created on 8/25/11 by SCK
;-

function i_miview, ptd_temp, ps=ps,polar=polar,short=short
...
if maxt le 10 and mint gt 0 then begin
    ...
    filename = 'dmatrix_mi_'+strtrim(fix(nf),2)+'.sav2'
    print, 'mono-interstitial'
endif else begin
    print, 'Not mono-intersitital'
    return,0
endelse
